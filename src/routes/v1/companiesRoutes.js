...
router.get('/', authMiddleware, companyController.getEntries);
router.get('/:companyId', authMiddleware, companyController.getEntry);
...
// departments
router.get('/:companyId/department', authMiddleware, departmentController.getEntries);
router.get('/:companyId/department/:departmentId', authMiddleware, departmentController.getEntry);
...
router.get('/:companyId/department/:departmentId/employee/', authMiddleware, employeeController.getEntries);
router.get('/:companyId/department/:departmentId/employee/:employeeId', authMiddleware, employeeController.getEntry);
...
// services
router.get('/:companyId/service', authMiddleware, serviceController.getEntries);
router.get('/:companyId/service/:serviceId', authMiddleware, serviceController.getEntry);
