...
router.get('/', resumeController.getEntries);
router.get('/search/:query', resumeController.getSearchResults);
router.get('/:resumeId', resumeController.getEntry);
...
// experience
router.get('/:resumeId/experience', experienceController.getEntries);
router.get('/:resumeId/experience/:experienceId', experienceController.getEntry);
...
// education
router.get('/:resumeId/education', educationController.getEntries);
router.get('/:resumeId/education/:educationId', educationController.getEntry);
...
// certificate
router.get('/:resumeId/certificate', certificateController.getEntries);
router.get('/:resumeId/certificate/:certificateId', certificateController.getEntry);
